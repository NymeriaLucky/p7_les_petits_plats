(() => {
    ...
    const e = {
            recipes: [
                ...
                },
                {
                    ...
                    servings: 4,
                    ingredients: [{ ingredient: "Patate douce", quantity: 800, unit: "grammes" }, { ingredient: "Crème fraîche", quantity: 20, unit: "cl" }, { ingredient: "Huile d'olive" }, { ingredient: "Orange", quantity: 1 }],
                    time: 25,
                    description:
        ...
        n = { displayedIng: [], displayedApp: [], displayedUst: [], displayedRecipes: [], ingLabels: [], appLabels: [], ustLabels: [], currentSearch: "", ingObj: {}, appObj: {}, ustObj: {} };
    var t,
        i,
        r,
        a = function (e) {
        ...
        u = function (e, n) {
            var t = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                i = a("a", t);
            return i.setAttribute("href", e), i.setAttribute("title", n), (i.textContent = n), i;
        },
        s = function (e) {
            return e
                .toLowerCase()
        ...
        f = function (e) {
            ...
            return (n.innerHTML = "<strong>".concat(e.ingredient)), (n.innerHTML += e.quantity ? " : </strong><span>".concat(e.quantity) : "</strong>"), (n.innerHTML += e.unit ? " ".concat(e.unit, "</span>") : "</span>"), n;
        },
        y = function (e) {
        ...
        q = function (e) {
            var n = document.getElementById("ing-filter-list"),
                t = U("ing");
            e.ingredients.forEach(function (e) {
                t.includes(e.ingredient.toLowerCase()) || n.appendChild(I("ing", e.ingredient.toLowerCase()));
            });
        },
        h = function (e) {
        ...
        C = function () {
            ...
            (function () {
                var t = document.getElementById("main-content"),
                    i = n.currentSearch;
                if (((n.displayedRecipes = []), i.length > 2)) {
                    var r = [],
                        a = [];
                    e.recipes.forEach(function (e) {
                        s(e.name).includes(s(i)) ? (y(e.id), t.appendChild(g(e)), n.displayedRecipes.push(e.id)) : (r.push(e), y(e.id));
                    }),
                        r.forEach(function (e) {
                            s(e.description).includes(s(i)) ? (y(e.id), t.appendChild(g(e)), n.displayedRecipes.push(e.id)) : (a.push(e), y(e.id));
                        }),
                        a.forEach(function (e) {
                            !(function (e) {
                                ...
                                return (
                                    e.ingredients.forEach(function (e) {
                                        n += " ".concat(s(e.ingredient));
                                    }),
                                    n
                                );
                            })(e).includes(s(i))
                                ? y(e.id)
                                : (y(e.id), t.appendChild(g(e)), n.displayedRecipes.push(e.id));
                        });
                } else t.innerHTML = "";
            })(),
                (t = n.ingLabels),
                ...
                (o = n.ustObj),
                (d = a),
                n.currentSearch.length < 3 &&
                    Q() > 0 &&
                    ((d = c()),
                    (p.innerHTML = ""),
                    e.recipes.forEach(function (e) {
                        var n = g(e);
                        (n.style.display = "block"), p.appendChild(n);
                    })),
                d.forEach(function (e) {
                    ...
                    t.forEach(function (t) {
                        ...
                        i.forEach(function (t) {
                            l[t].includes(e) || (n.style.display = "none");
                        }),
                        r.forEach(function (t) {
                            o[t].includes(e) || (n.style.display = "none");
                        });
                }),
                (function () {
                    var t,
            ...
            return (
                e.forEach(function (e) {
                    var i = (function (e, n) {
                        ...
                        return i.addEventListener("click", z(e, n)), (t.textContent = n), t.appendChild(i), t;
                    })(n, e);
                    t.appendChild(i);
                }),
                t
        ...
        S = function () {
            (j.innerHTML = ""), j.appendChild(L(n.ingLabels, "ing")), j.appendChild(L(n.appLabels, "app")), j.appendChild(L(n.ustLabels, "ust"));
        },
        z = function (e, t) {
            return function (i) {
                i.preventDefault();
                var r = s(t);
                    "ing" === e &&
                        (n.ingLabels = n.ingLabels.filter(function (e) {
                           return r !== e;
                    })),
                    "app" === e &&
                        (n.appLabels = n.appLabels.filter(function (e) {
                            return r !== e;
                        })),
                    "ust" === e &&
                        (n.ustLabels = n.ustLabels.filter(function (e) {
                            return r !== e;
                        })),
                    S(),
                    C();
        ...
        I = function (e, n) {
            var t = a("li"),
                i = u("/", n, "filter-tag");
            return t.appendChild(i), t.addEventListener("click", N(e, n)), t;
        },
        N = function (e, t) {
            return function (i) {
                i.preventDefault();
                var r = s(t);
                "ing" === e && (n.ingLabels.includes(r) || n.ingLabels.push(r)), "app" === e && (n.appLabels.includes(r) || n.appLabels.push(r)), "ust" === e && (n.ustLabels.includes(r) || n.ustLabels.push(r)), J(), S(), C();
            };
        },
        w = function (e, n) {
            (e.innerHTML = ""),
        ...
        k = function (e) {
            e.preventDefault(), "SPAN" === e.target.tagName && ("fas fa-chevron-down" === e.target.className ? V(e) : (H(), G()));
        },
        H = function () {
        ...
        V = function (e) {
            ...
            (n.className += " scaled"), R(n.childNodes[3], n.childNodes[2].id);
        },
        R = function (e, n) {
            H(), (e.className += " open"), (document.getElementById(n).className = "fas fa-chevron-up"), (E.style.display = "block");
        },
        G = function () {
        ...
        K = function () {
            (A.innerHTML = ""), (x.innerHTML = ""), (M.innerHTML = "");
        },
        Q = function () {
            return n.ingLabels.concat(n.appLabels).concat(n.ustLabels).length;
        },
        W = function () {
            (O.value = ""), (T.value = ""), (D.value = "");
        },
        X = function (e) {
            var n = e.target.parentNode.id,
                t = s(e.target.value);
            document.querySelectorAll("#".concat(n, " li a")).forEach(function (e) {
                e.textContent.includes(t) ? (e.parentNode.style.display = "block") : (e.parentNode.style.display = "none");
            });
        },
        Y = function () {
    ...
    (n.displayedIng = l()),
        ...
        document.getElementById("search-bar").addEventListener("input", function (e) {
            e.preventDefault(), (n.currentSearch = e.target.value), C();
        });
})();

(()=>{"use strict";//avant modif :recipes.js
 const e={recipes:

   [{id:1,
	 name:"Limonade de Coco",
	 servings:1,
	 ingredients:[{ingredient:"Lait de coco",
	...
	{id:2,
	 ...
	 servings:2,
	 ingredients:[{ingredient:"Thon Rouge (ou blanc)",quantity:200,unit:"grammes"},
	...
	servings:4,
	ingredients:[{ingredient:"Poulet",quantity:1},
   ...
   name:"Salade de riz",
   servings:4,
   ingredients:[{ingredient:"Riz blanc",quantity:500,unit:"grammes"},
   ...
   name:"Tarte au thon",
   servings:4,
   ingredients:[{ingredient:"Pâte feuilletée",quantity:1},
			    ...
			    {ingredient:"Moutarde de Dijon",quantity:1,unit:"cuillères à soupe"}],
	time:45,
   ...
   servings:6,
   ingredients:[{ingredient:"Pâte brisée",quantity:1},
   ...
   servings:6,
   ingredients:[{ingredient:"Pâte sablée",quantity:1},
   ...
   name:"Brownie",
   servings:10,
   ingredients:[{ingredient:"Noix",quantity:"180",unit:"grammes"},
   ...
   servings:4,
   ingredients:[{ingredient:"Concombre",quantity:1},{ingredient:"Olives"},
			    {ingredient:"Fromage de chèvre",quantity:150,unit:"grammes"},
			    {ingredient:"Vinaigre Balsamic"},{ingredient:"Huile d'olive"},
			    {ingredient:"Basilic"}],
   time:15,
  ...
  name:"Tartiflette",
  servings:4,
  ingredients:[{ingredient:"Roblochon",quantity:"1"},
  ...
  servings:4,
  ingredients:[{ingredient:"Tomates cerises",quantity:250,unit:"grammes"},
  ...
  servings:4,
  ingredients:[{ingredient:"Rhubarbe",quantity:160,unit:"grammes"},
  ...
  servings:2,
  ingredients:[{ingredient:"Mâche",quantity:60,unit:"grammes"},
  ...
  servings:2,
  ingredients:[{ingredient:"Saucisse bretonne ou de toulouse",quantity:2},
  ...
  servings:10,
  ingredients:[{ingredient:"Oeuf",quantity:3},
  ...
  servings:2,
  ingredients:[{ingredient:"Tomate",quantity:500,unit:"grammes"},
  ...
  {id:17,name:"Smoothie à la fraise",
  servings:6,
  ingredients:[{ingredient:"Fraise",quantity:500,unit:"grammes"},
			   {ingredient:"Pastèque",quantity:.5},
  ...
  servings:5,
  ingredients:[{ingredient:"Ananas",quantity:1},
  ...
  servings:4,
  ingredients:[{ingredient:"Kiwi",quantity:4},
  ...
  servings:5,
  ingredients:[{ingredient:"Tagliatelles",quantity:500,unit:"grammes"},
  ...
  servings:4,
  ingredients:[{ingredient:"Spaghettis",quantity:400,unit:"grammes"},
  ...
  servings:4,
  ingredients:[{ingredient:"Beurre",quantity:160,unit:"grammes"},
  ...
  servings:4,
  ingredients:[{ingredient:"Pâte brisée",quantity:200,unit:"grammes"},
  ...
  servings:4,
  ingredients:[{ingredient:"Thon en miettes",quantity:160,unit:"grammes"},
			   {ingredient:"Maïs",quantity:60,unit:"grammes"},
			   {ingredient:"Tomate",quantity:1},
			   {ingredient:"Concombre",quantity:.5},
  ...
  name:"Cookies",
  servings:4,
  ingredients:[{ingredient:"Sucre",quantity:100,unit:"grammes"},
  ...
  appliance:"Four",ustensils:["fouet","saladier","plaque de cuisson"]},

  {id:26,
  name:"Soupe de tomates",servings:2,
  ingredients:[{ingredient:"Tomate",quantity:6},
  ...
  servings:4,
  ingredients:[{ingredient:"Oseille",quantity:2},
                          {ingredient:"Oeuf",quantity:1},
  ...
  servings:4,
  ingredients:[{ingredient:"Poireau",quantity:3},
  ...
  servings:2,
  ingredients:[{ingredient:"Pois chiches",quantity:1,unit:"boites"},
			   {ingredient:"Ail",quantity:1,unit:"gousses"},
  ...
  servings:4,
  ingredients:[{ingredient:"Pois Cassé",quantity:500,unit:"grammes"},
			   {ingredient:"Oignon",quantity:1},
  ...
  servings:4,
  ingredients:[{ingredient:"Carotte",quantity:2},
  ...
  servings:4,
  ingredients:[{ingredient:"Pain de mie",quantity:8,unit:"tranches"},
  ...
  servings:4,
  ingredients:[{ingredient:"Patate douce",quantity:800,unit:"grammes"},
			   {ingredient:"Crème fraîche",quantity:20,unit:"cl"},
			   {ingredient:"Huile d'olive"},
  ...
  servings:2,
  ingredients:[{ingredient:"Carotte",quantity:6},
			   {ingredient:"Pommes de terre",quantity:1},
  ...
  servings:2,
  ingredients:[{ingredient:"Courgette",quantity:2},
  ...
  name:"Pain Perdu",
  servings:4,
  ingredients:[{ingredient:"Pain",quantity:6,unit:"tranches"},
			   {ingredient:"Lait",quantity:25,unit:"cl"},
			   {ingredient:"Oeuf",quantity:3},
  ...
  servings:40,
  ingredients:[{ingredient:"Pomme",quantity:2},
			   {ingredient:"Farine",quantity:100,unit:"grammes"},
			   {ingredient:"Beurre",quantity:50,unit:"grammes"},
  ...
  {id:40,name:"Limonade",
  servings:4,
  ingredients:[{ingredient:"Eau",quantity:1,unit:"Litres"},
  ...
  servings:3,
  ingredients:[{ingredient:"Chocolat",quantity:200,unit:"grammes"},
			   {ingredient:"Oeuf",quantity:3},
			   {ingredient:"Poires au jus",quantity:.5,unit:"boites"},
  ...
  servings:6,
  ingredients:[{ingredient:"Lait",quantity:1,unit:"litres"},
  ...
  servings:8,
  ingredients:[{ingredient:"Lait",quantity:50,unit:"cl"},
			   {ingredient:"Oeuf",quantity:2},{ingredient:"Farine",quantity:30,unit:"grammes"},
  ...
  {id:46,name:"Far breton",
  servings:6,
  ingredients:[{ingredient:"Farine",quantity:250,unit:"grammes"},
			   {ingredient:"Sucre",quantity:150,unit:"grammes"},
			   {ingredient:"Sucre vanillé",quantity:1,unit:"sachets"},
			   {ingredient:"Oeuf",quantity:4},
  ...
  servings:6,
  ingredients:[{ingredient:"Jus de citron",quantity:100,unit:"grammes"},
  ...
  {id:48,name:"Pizza",
  servings:4,
  ingredients:[{ingredient:"Pâte à pizza",quantity:1},
  ...
  servings:4,
  ingredients:[{ingredient:"Bananes",quantity:2},
  ...
  name:"Frangipane",
  servings:2,
  ingredients:[{ingredient:"Pâte feuilletée",quantity:400,unit:"grammes"},
  ...
  ustensils:["rouleau à patisserie","fouet"]
	...
	var t,i,r,a=function(e){
	var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null,
	t=document.createElement(e);
	  return n&&(t.className=n),t},
	u=function(e,n){
	var t=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,i=a("a",t);
	  return i.setAttribute("href",e),
	i.setAttribute("title",n),i.textContent=n,i},
	s=function(e){
	...
	n.includes(e.ingredient.toLowerCase())||n.push(e.ingredient.toLowerCase())
	  }))
	})),
	n.map((function(e){
	   return{type:"ing",name:e}
			  			}))
			  	    },
	o=function(){
	var n=[];
		return e.recipes.forEach((function(e){
	n.includes(e.appliance.toLowerCase())||n.push(e.appliance.toLowerCase())})),
	n.map((function(e){
		return{type:"app",
		       name:e}
			  	}))
	...
	var n=[];
		return e.recipes.forEach((function(e){
	e.ustensils.forEach((function(e){
	n.includes(e.toLowerCase())||n.push(e.toLowerCase())
			}))
		})),
	n.map((function(e){
		return{type:"ust",
	...
	c=function(){
		return e.recipes.map((function(e){
		return e.id
			}))
		},
	m=function(e){
	...
	g=function(e){
	var n=a("article","recipe");
	n.id=e.id;
	var t=u("index.html",e.name);
	t.textContent="";
	var i=a("div","recipe-img"),
	r=a("div","recipe-data"),
	s=a("header"),
	l=a("h2"),
	o=a("div","recipe-time"),
	d=a("div","recipe-category"),
	c=a("div","recipe-category"),
	m=a("ul");
	...
	o.innerHTML='<span class="far fa-clock"></span> '.concat(e.time," min"),
	...
	var n=document.createElement("li");
		return n.innerHTML="<strong>".concat(e.ingredient),
	n.innerHTML+=e.quantity?" : </strong><span>".concat(e.quantity):"</strong>",
	n.innerHTML+=e.unit?" ".concat(e.unit,"</span>"):"</span>",n
			},
	y=function(e){
	...
	q(e),h(e),b(e)},
	q=function(e){
	var n=document.getElementById("ing-filter-list"), 
	t=U("ing");//stop here
	 e.ingredients.forEach((function(e){
		                    t.includes(e.ingredient.toLowerCase())||n.appendChild(I("ing",
	 e.ingredient.toLowerCase()))}
	            ))},
	h=function(e){
		var n=document.getElementById("app-filter-list");
	       U("app").includes(e.appliance.toLowerCase())||n.appendChild(I("app",e.appliance.toLowerCase()))
		         },
	b=function(e){
		var n=document.getElementById("ust-filter-list"),
	        t=U("ust");
	            e.ustensils.forEach((function(e){
			                           t.includes(e.toLowerCase())||n.appendChild(I("ust",e.toLowerCase()))
									            }
			    ))},
	C=function(){
	   var t,i,r,a,u,l,o,d;
	   (function(){
	    var t=document.getElementById("main-content"),
	       i=n.currentSearch;
		  if(n.displayedRecipes=[],
			i.length>2){
	    var r=[],
	        a=[];
	   e.recipes.forEach((function(e){
	     s(e.name).includes(s(i))?(y(e.id),
	   t.appendChild(g(e)),
	   n.displayedRecipes.push(e.id)):(r.push(e),
	     y(e.id))})),
	   r.forEach((function(e){
		   s(e.description).includes(s(i))?(y(e.id),
	   t.appendChild(g(e)),
	   n.displayedRecipes.push(e.id)):(a.push(e),
	       y(e.id))
		   })),
	   a.forEach((function(e){!function(e){
	    var n="";
		  return e.ingredients.forEach((function(e){
		             n+=" ".concat(s(e.ingredient))})),n
					                      }
		            (e).includes(s(i))?y(e.id):(y(e.id),
				 t.appendChild(g(e)),
		         n.displayedRecipes.push(e.id))}))
				}else t.innerHTML=""})(),
	         t=n.ingLabels,  
	         i=n.appLabels,
	         r=n.ustLabels,
	         a=n.displayedRecipes,
	         u=n.ingObj,
	         l=n.appObj,
	         o=n.ustObj,
	         d=a,
		         n.currentSearch.length<3&&Q()>0&&(d=c(),p.innerHTML="",
		         e.recipes.forEach((function(e){
	                                 var n=g(e);
	   ...
	   t.forEach((function(t){
		    u[t].includes(e)||(n.style.display="none")})),
	   i.forEach((function(t){l[t].includes(e)||(n.style.display="none")})),
	   r.forEach((function(t){o[t].includes(e)||(n.style.display="none")}))})),

	 function(){
            var t,i=[];
		        if(n.currentSearch.length<3&&0===Q())i=e.recipes;
		        else{
			var r=document.querySelectorAll("#main-content article"),
			  	a=Array.from(r).filter((function(e){
			  		return"block"===e.style.display})).map((function(e){
			  		return parseInt(e.id)}));
			  	t=a,
				i=e.recipes.filter((function(e){
			  		     return t.includes(e.id)}))}K(),
		i.forEach((function(e){
			  		return v(e)}))
				}(),

	 function(){
			var e=document.querySelectorAll("#main-content article"),
			  	t=document.getElementById("result"),
			  	i=Array.from(e).filter((function(e){
			  			return"none"===e.style.display}));
			  	0===e.length||i.length===e.length?n.currentSearch.length<3&&0===Q()?t.textContent="":t.textContent="Aucune recette ne correspond à votre critère…":t.textContent=""}()},
			  	j=document.getElementById("labels"),
			  	L=function(e,n){
			var t=document.createElement("div");
			  		return e.forEach((function(e){
			 var i=function(e,n){
			  var t=a("button","label ".concat(e));
			  	t.setAttribute("type","button");
			var i=a("span","far fa-times-circle");
			  		return i.addEventListener("click",z(e,n)),
			  	t.textContent=n,
				t.appendChild(i),t}
				   (n,e);t.appendChild(i)})),t},
			  	S=function(){j.innerHTML="",
			  	 j.appendChild(L(n.ingLabels,"ing")),
			  	 j.appendChild(L(n.appLabels,"app")),
			  	 j.appendChild(L(n.ustLabels,"ust"))},
				z=function(e,t){
			  			return function(i){i.preventDefault();
			var r=s(t);
			  	"ing"===e&&(n.ingLabels=n.ingLabels.filter((function(e){
			  			return r!==e}))),
			  	"app"===e&&(n.appLabels=n.appLabels.filter((function(e){
			  			return r!==e}))),
			  	"ust"===e&&(n.ustLabels=n.ustLabels.filter((function(e){
			  			return r!==e}))),S(),C()}},
			    E=document.getElementById("overlay"),
			  	A=document.getElementById("ing-filter-list"),
			  	x=document.getElementById("app-filter-list"),
			  	M=document.getElementById("ust-filter-list"),
			  	P=document.getElementById("ing-btn"),
			  	B=document.getElementById("app-btn"),
			  	F=document.getElementById("ust-btn"),
			  	O=document.getElementById("ing-input"),
			  	T=document.getElementById("app-input"),
			  	D=document.getElementById("ust-input"),
			  	I=function(e,n){
			var t=a("li"),
			  	i=u("/",n,"filter-tag");
			  		return t.appendChild(i),
			  	t.addEventListener("click",N(e,n)),t},
			  	N=function(e,t){
			  		return function(i){
			  	i.preventDefault();
			var r=s(t);
			  	"ing"===e&&(n.ingLabels.includes(r)||n.ingLabels.push(r)),
			  	"app"===e&&(n.appLabels.includes(r)||n.appLabels.push(r)),
			  	"ust"===e&&(n.ustLabels.includes(r)||n.ustLabels.push(r)),
			  		J(),
			  		S(),
			  		C()}
			  		},
			  	w=function(e,n){e.innerHTML="",
			  		n.forEach((function(n){
			var t=I(n.type,n.name);
			  		e.appendChild(t)}))
				               },
			  	k=function(e){
			  		e.preventDefault(),

   "SPAN"===e.target.tagName&&("fas fa-chevron-down"===e.target.className?V(e):(H(),G()))},
    H=function(){
		E.style.display="none",
		A.parentNode.classList.remove("open"),
		x.parentNode.classList.remove("open"),
		M.parentNode.classList.remove("open"),
		P.className="fas fa-chevron-down",
		B.className="fas fa-chevron-down",
		F.className="fas fa-chevron-down",
			W(),
			Y() },
	V=function(e){
		e.preventDefault(),G();
     var n=e.target.parentNode;
        n.className+=" scaled",
		R(n.childNodes[3],n.childNodes[2].id)},
	R=function(e,n){
		H(),
		e.className+=" open",
		document.getElementById(n).className="fas fa-chevron-up",
		E.style.display="block"},
	G=function(){
		document.querySelectorAll(".filters-elt").forEach((function(e){
			  		return e.classList.remove("scaled")}))},
	J=function(){
			   H(),
			   G()
                },
	U=function(e){
     var n=document.querySelectorAll("#".concat(e,"-filter-list li a"));
	...
	K=function(){
			...
			M.innerHTML=""},
	Q=function(){
			return n.ingLabels.concat(n.appLabels).concat(n.ustLabels).length},
	W=function(){
			O.value="",
			T.value="",
			D.value=""},
	X=function(e){
     var n=e.target.parentNode.id,
	     t=s(e.target.value);
	document.querySelectorAll("#".concat(n," li a")).forEach((function(e){e.textContent.includes(t)?e.parentNode.style.display="block":e.parentNode.style.display="none"}))},
	Y=function(){
  var e=document.querySelectorAll("#ing-filter-list li"),
	  n=document.querySelectorAll("#app-filter-list li"),
	  t=document.querySelectorAll("#ust-filter-list li");
		...
		n.displayedApp=o(),
		n.displayedUst=d(),
		n.displayedRecipes=c(),
		n.ingObj=(r=m(l()),
		e.recipes.forEach((function(e){
		e.ingredients.forEach((function(n){
  var t=s(n.ingredient);
      r[t].push(e.id)}))
	             })),r),
	    n.appObj=(i=m(o()),
		e.recipes.forEach((function(e){
  var n=s(e.appliance);
		...
		n.ustObj=(t=m(d()),
		e.recipes.forEach((function(e){
		  e.ustensils.forEach((function(n){
  var i=s(n);
        t[i].push(e.id)}))
	                })),t),
		w(A,n.displayedIng),
...
(function(e){
          e.preventDefault(),
		  n.currentSearch=e.target.value,C()
			  			}))
			  		})();
